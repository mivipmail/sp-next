...
export const CdekAddress = sequelize.define('cdek_address',
    {
        id: {type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true},
...
export const CdekCity = sequelize.define('cdek_city',
    {
        id: {type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true},
...
export const BaseCity = sequelize.define('base_city',
    {
        id: {type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true},
        city: {type: DataTypes.STRING, allowNull: true},
